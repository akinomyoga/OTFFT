/******************************************************************************
*  OTFFT DITAVX8 Version 4.0
******************************************************************************/

#ifndef otfft_ditavx8_h
...
const int OMP_THRESHOLD = OTFFT_DITAVX::OMP_THRESHOLD;
...
template <> struct fwd0but<2,1,0>
{
    ...
    {
        OTFFT_DITAVX::fwd0but<2,1,0>()(x, y, W);
    }
};
...
template <> struct fwd0but<2,1,1>
{
    inline void operator()(complex_vector x, complex_vector y, const_complex_vector W) const
    {
        OTFFT_DITAVX::fwd0but<2,1,1>()(x, y, W);
    }
};
...
template <> struct inv0but<2,1,0>
{
    inline void operator()(complex_vector x, complex_vector y, const_complex_vector W) const
    {
        OTFFT_DITAVX::inv0but<2,1,0>()(x, y, W);
    }
};
...
template <> struct inv0but<2,1,1>
{
    inline void operator()(complex_vector x, complex_vector y, const_complex_vector W) const
    {
        OTFFT_DITAVX::inv0but<2,1,1>()(x, y, W);
    }
};
...
template <int s> struct fwd0but<2,s,0>
{
    inline void operator()(complex_vector x, complex_vector y, const_complex_vector W) const
    {
        OTFFT_DITAVX::fwd0but<2,s,0>()(x, y, W);
    }
};
...
template <int s> struct fwd0but<2,s,1>
{
    inline void operator()(complex_vector x, complex_vector y, const_complex_vector W) const
    {
        OTFFT_DITAVX::fwd0but<2,s,1>()(x, y, W);
    }
};
...
template <int s> struct inv0but<2,s,0>
{
    inline void operator()(complex_vector x, complex_vector y, const_complex_vector W) const
    {
        OTFFT_DITAVX::inv0but<2,s,0>()(x, y, W);
    }
};
...
template <int s> struct inv0but<2,s,1>
{
    inline void operator()(complex_vector x, complex_vector y, const_complex_vector W) const
    {
        OTFFT_DITAVX::inv0but<2,s,1>()(x, y, W);
    }
};
...
template <> struct fwd0but<4,1,0>
{
    inline void operator()(complex_vector x, complex_vector y, const_complex_vector W) const
    {
        OTFFT_DITAVX::fwd0but<4,1,0>()(x, y, W);
    }
};
...
template <> struct fwd0but<4,1,1>
{
    inline void operator()(complex_vector x, complex_vector y, const_complex_vector W) const
    {
        OTFFT_DITAVX::fwd0but<4,1,1>()(x, y, W);
    }
};
...
template <> struct inv0but<4,1,0>
{
    inline void operator()(complex_vector x, complex_vector y, const_complex_vector W) const
    {
        OTFFT_DITAVX::inv0but<4,1,0>()(x, y, W);
    }
};
...
template <> struct inv0but<4,1,1>
{
    inline void operator()(complex_vector x, complex_vector y, const_complex_vector W) const
    {
        OTFFT_DITAVX::inv0but<4,1,1>()(x, y, W);
    }
};
...
template <int s> struct fwd0but<4,s,0>
{
    inline void operator()(complex_vector x, complex_vector y, const_complex_vector W) const
    {
        OTFFT_DITAVX::fwd0but<4,s,0>()(x, y, W);
    }
};
...
template <int s> struct fwd0but<4,s,1>
{
    inline void operator()(complex_vector x, complex_vector y, const_complex_vector W) const
    {
        OTFFT_DITAVX::fwd0but<4,s,1>()(x, y, W);
    }
};
...
template <int s> struct inv0but<4,s,0>
{
    inline void operator()(complex_vector x, complex_vector y, const_complex_vector W) const
    {
        OTFFT_DITAVX::inv0but<4,s,0>()(x, y, W);
    }
};
...
template <int s> struct inv0but<4,s,1>
{
    inline void operator()(complex_vector x, complex_vector y, const_complex_vector W) const
    {
        OTFFT_DITAVX::inv0but<4,s,1>()(x, y, W);
    }
};
...
struct FFT0
{
    ...
    inline void fwd0o(complex_vector x, complex_vector y) const
    {
        if (N < 2) return;
        switch (log_N) {
        case  1: fwd0but<(1<< 1),1,1>()(y, x, W); break;
        case  2: fwd0but<(1<< 2),1,1>()(y, x, W); break;
        case  3: fwd0but<(1<< 3),1,1>()(y, x, W); break;
        case  4: fwd0but<(1<< 4),1,1>()(y, x, W); break;
        case  5: fwd0but<(1<< 5),1,1>()(y, x, W); break;
        case  6: fwd0but<(1<< 6),1,1>()(y, x, W); break;
        case  7: fwd0but<(1<< 7),1,1>()(y, x, W); break;
        case  8: fwd0but<(1<< 8),1,1>()(y, x, W); break;
        case  9: fwd0but<(1<< 9),1,1>()(y, x, W); break;
        case 10: fwd0but<(1<<10),1,1>()(y, x, W); break;
        case 11: fwd0but<(1<<11),1,1>()(y, x, W); break;
        case 12: fwd0but<(1<<12),1,1>()(y, x, W); break;
        case 13: fwd0but<(1<<13),1,1>()(y, x, W); break;
        case 14: fwd0but<(1<<14),1,1>()(y, x, W); break;
        case 15: fwd0but<(1<<15),1,1>()(y, x, W); break;
        case 16: fwd0but<(1<<16),1,1>()(y, x, W); break;
        case 17: fwd0but<(1<<17),1,1>()(y, x, W); break;
        case 18: fwd0but<(1<<18),1,1>()(y, x, W); break;
        case 19: fwd0but<(1<<19),1,1>()(y, x, W); break;
        case 20: fwd0but<(1<<20),1,1>()(y, x, W); break;
        case 21: fwd0but<(1<<21),1,1>()(y, x, W); break;
        case 22: fwd0but<(1<<22),1,1>()(y, x, W); break;
        case 23: fwd0but<(1<<23),1,1>()(y, x, W); break;
        case 24: fwd0but<(1<<24),1,1>()(y, x, W); break;
        }
    }
    ...
    inline void fwdno(complex_vector x, complex_vector y) const
    {
        if (N < 2) return;
        switch (log_N) {
        case  1: fwdnbut<(1<< 1),1,1>()(y, x, W); break;
        case  2: fwdnbut<(1<< 2),1,1>()(y, x, W); break;
        case  3: fwdnbut<(1<< 3),1,1>()(y, x, W); break;
        case  4: fwdnbut<(1<< 4),1,1>()(y, x, W); break;
        case  5: fwdnbut<(1<< 5),1,1>()(y, x, W); break;
        case  6: fwdnbut<(1<< 6),1,1>()(y, x, W); break;
        case  7: fwdnbut<(1<< 7),1,1>()(y, x, W); break;
        case  8: fwdnbut<(1<< 8),1,1>()(y, x, W); break;
        case  9: fwdnbut<(1<< 9),1,1>()(y, x, W); break;
        case 10: fwdnbut<(1<<10),1,1>()(y, x, W); break;
        case 11: fwdnbut<(1<<11),1,1>()(y, x, W); break;
        case 12: fwdnbut<(1<<12),1,1>()(y, x, W); break;
        case 13: fwdnbut<(1<<13),1,1>()(y, x, W); break;
        case 14: fwdnbut<(1<<14),1,1>()(y, x, W); break;
        case 15: fwdnbut<(1<<15),1,1>()(y, x, W); break;
        case 16: fwdnbut<(1<<16),1,1>()(y, x, W); break;
        case 17: fwdnbut<(1<<17),1,1>()(y, x, W); break;
        case 18: fwdnbut<(1<<18),1,1>()(y, x, W); break;
        case 19: fwdnbut<(1<<19),1,1>()(y, x, W); break;
        case 20: fwdnbut<(1<<20),1,1>()(y, x, W); break;
        case 21: fwdnbut<(1<<21),1,1>()(y, x, W); break;
        case 22: fwdnbut<(1<<22),1,1>()(y, x, W); break;
        case 23: fwdnbut<(1<<23),1,1>()(y, x, W); break;
        case 24: fwdnbut<(1<<24),1,1>()(y, x, W); break;
        }
    }
    ...
    inline void inv0o(complex_vector x, complex_vector y) const
    {
        if (N < 2) return;
        switch (log_N) {
        case  1: inv0but<(1<< 1),1,1>()(y, x, W); break;
        case  2: inv0but<(1<< 2),1,1>()(y, x, W); break;
        case  3: inv0but<(1<< 3),1,1>()(y, x, W); break;
        case  4: inv0but<(1<< 4),1,1>()(y, x, W); break;
        case  5: inv0but<(1<< 5),1,1>()(y, x, W); break;
        case  6: inv0but<(1<< 6),1,1>()(y, x, W); break;
        case  7: inv0but<(1<< 7),1,1>()(y, x, W); break;
        case  8: inv0but<(1<< 8),1,1>()(y, x, W); break;
        case  9: inv0but<(1<< 9),1,1>()(y, x, W); break;
        case 10: inv0but<(1<<10),1,1>()(y, x, W); break;
        case 11: inv0but<(1<<11),1,1>()(y, x, W); break;
        case 12: inv0but<(1<<12),1,1>()(y, x, W); break;
        case 13: inv0but<(1<<13),1,1>()(y, x, W); break;
        case 14: inv0but<(1<<14),1,1>()(y, x, W); break;
        case 15: inv0but<(1<<15),1,1>()(y, x, W); break;
        case 16: inv0but<(1<<16),1,1>()(y, x, W); break;
        case 17: inv0but<(1<<17),1,1>()(y, x, W); break;
        case 18: inv0but<(1<<18),1,1>()(y, x, W); break;
        case 19: inv0but<(1<<19),1,1>()(y, x, W); break;
        case 20: inv0but<(1<<20),1,1>()(y, x, W); break;
        case 21: inv0but<(1<<21),1,1>()(y, x, W); break;
        case 22: inv0but<(1<<22),1,1>()(y, x, W); break;
        case 23: inv0but<(1<<23),1,1>()(y, x, W); break;
        case 24: inv0but<(1<<24),1,1>()(y, x, W); break;
        }
    }
    ...
    inline void invno(complex_vector x, complex_vector y) const
    {
        if (N < 2) return;
        switch (log_N) {
        case  1: invnbut<(1<< 1),1,1>()(y, x, W); break;
        case  2: invnbut<(1<< 2),1,1>()(y, x, W); break;
        case  3: invnbut<(1<< 3),1,1>()(y, x, W); break;
        case  4: invnbut<(1<< 4),1,1>()(y, x, W); break;
        case  5: invnbut<(1<< 5),1,1>()(y, x, W); break;
        case  6: invnbut<(1<< 6),1,1>()(y, x, W); break;
        case  7: invnbut<(1<< 7),1,1>()(y, x, W); break;
        case  8: invnbut<(1<< 8),1,1>()(y, x, W); break;
        case  9: invnbut<(1<< 9),1,1>()(y, x, W); break;
        case 10: invnbut<(1<<10),1,1>()(y, x, W); break;
        case 11: invnbut<(1<<11),1,1>()(y, x, W); break;
        case 12: invnbut<(1<<12),1,1>()(y, x, W); break;
        case 13: invnbut<(1<<13),1,1>()(y, x, W); break;
        case 14: invnbut<(1<<14),1,1>()(y, x, W); break;
        case 15: invnbut<(1<<15),1,1>()(y, x, W); break;
        case 16: invnbut<(1<<16),1,1>()(y, x, W); break;
        case 17: invnbut<(1<<17),1,1>()(y, x, W); break;
        case 18: invnbut<(1<<18),1,1>()(y, x, W); break;
        case 19: invnbut<(1<<19),1,1>()(y, x, W); break;
        case 20: invnbut<(1<<20),1,1>()(y, x, W); break;
        case 21: invnbut<(1<<21),1,1>()(y, x, W); break;
        case 22: invnbut<(1<<22),1,1>()(y, x, W); break;
        case 23: invnbut<(1<<23),1,1>()(y, x, W); break;
        case 24: invnbut<(1<<24),1,1>()(y, x, W); break;
        }
    }
};
