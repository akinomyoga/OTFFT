...
#if _MSC_VER < 1800
static inline long lrint(const double& x)
{
...
static inline double norm(const complex_t& z) noexcept { return z.Re*z.Re + z.Im*z.Im; }
static inline complex_t conj(const complex_t& z) noexcept force_inline;
static inline complex_t conj(const complex_t& z) noexcept { return complex_t(z.Re, -z.Im); }
static inline complex_t jx(const complex_t& z) noexcept force_inline;
static inline complex_t jx(const complex_t& z) noexcept { return complex_t(-z.Im, z.Re); }
static inline complex_t neg(const complex_t& z) noexcept force_inline;
static inline complex_t neg(const complex_t& z) noexcept { return complex_t(-z.Im, -z.Re); }
static inline complex_t v8x(const complex_t& z) noexcept force_inline;
static inline complex_t v8x(const complex_t& z) noexcept { return complex_t(M_SQRT1_2*(z.Re-z.Im), M_SQRT1_2*(z.Re+z.Im)); }
static inline complex_t w8x(const complex_t& z) noexcept force_inline;
static inline complex_t w8x(const complex_t& z) noexcept { return complex_t(M_SQRT1_2*(z.Re+z.Im), M_SQRT1_2*(z.Im-z.Re)); }
...
static inline xmm cmplx(const double& x, const double& y) noexcept { return _mm_setr_pd(x, y); }
static inline xmm getpz(const complex_t& z) noexcept force_inline;
static inline xmm getpz(const complex_t& z) noexcept { return _mm_load_pd(&z.Re); }
static inline xmm getpz(const_double_vector x) noexcept force_inline2;
static inline xmm getpz(const_double_vector x) noexcept { return _mm_load_pd(x); }
static inline void setpz(complex_t& z, const xmm x) noexcept force_inline3;
static inline void setpz(complex_t& z, const xmm x) noexcept { _mm_store_pd(&z.Re, x); }
static inline void setpz(double_vector x, const xmm z) noexcept force_inline3;
static inline void setpz(double_vector x, const xmm z) noexcept { _mm_store_pd(x, z); }
...
static inline xmm addpz(const xmm a, const xmm b) noexcept { return _mm_add_pd(a, b); }
static inline xmm subpz(const xmm a, const xmm b) noexcept force_inline;
static inline xmm subpz(const xmm a, const xmm b) noexcept { return _mm_sub_pd(a, b); }
static inline xmm mulpd(const xmm a, const xmm b) noexcept force_inline;
static inline xmm mulpd(const xmm a, const xmm b) noexcept { return _mm_mul_pd(a, b); }
static inline xmm divpd(const xmm a, const xmm b) noexcept force_inline;
static inline xmm divpd(const xmm a, const xmm b) noexcept { return _mm_div_pd(a, b); }
static inline xmm xorpd(const xmm a, const xmm b) noexcept force_inline;
static inline xmm xorpd(const xmm a, const xmm b) noexcept { return _mm_xor_pd(a, b); }
...
static inline void setpz(complex_t& z, const xmm& x) noexcept force_inline3;
static inline void setpz(complex_t& z, const xmm& x) noexcept { z.Re = x.Re; z.Im = x.Im; }
static inline void setpz(double_vector x, const xmm z) noexcept force_inline3;
static inline void setpz(double_vector x, const xmm z) noexcept { x[0] = z.Re; x[1] = z.Im; }
...
static inline xmm cnjpz(const xmm& z) noexcept { const xmm x = { z.Re, -z.Im }; return x; }
static inline xmm jxpz(const xmm& z) noexcept force_inline;
static inline xmm jxpz(const xmm& z) noexcept { const xmm x = { -z.Im, z.Re }; return x; }
static inline xmm negpz(const xmm& z) noexcept force_inline;
static inline xmm negpz(const xmm& z) noexcept { const xmm x = { -z.Re, -z.Im }; return x; }
...
static inline xmm h1xpz(const xmm& z) noexcept force_inline;
static inline xmm h1xpz(const xmm& z) noexcept
{
...
static inline xmm h3xpz(const xmm& z) noexcept force_inline;
static inline xmm h3xpz(const xmm& z) noexcept
{
    static const xmm r1 = { M_SQRT1_2, M_SQRT1_2 };
    static const xmm r2 = { RSQRT2PSQRT2, RSQRT2PSQRT2 };
...
static inline xmm hfxpz(const xmm& z) noexcept force_inline;
static inline xmm hfxpz(const xmm& z) noexcept
{
    static const xmm r = { RSQRT2PSQRT2, RSQRT2PSQRT2 };
...
static inline xmm hdxpz(const xmm& z) noexcept force_inline;
static inline xmm hdxpz(const xmm& z) noexcept
{
    static const xmm r1 = { M_SQRT1_2, M_SQRT1_2 };
    static const xmm r2 = { RSQRT2PSQRT2, RSQRT2PSQRT2 };
    const xmm jz = jxpz(z);
...
static inline ymm addpz2(const ymm a, const ymm b) noexcept { return _mm256_add_pd(a, b); }
static inline ymm subpz2(const ymm a, const ymm b) noexcept force_inline;
static inline ymm subpz2(const ymm a, const ymm b) noexcept { return _mm256_sub_pd(a, b); }
static inline ymm mulpd2(const ymm a, const ymm b) noexcept force_inline;
static inline ymm mulpd2(const ymm a, const ymm b) noexcept { return _mm256_mul_pd(a, b); }
static inline ymm divpd2(const ymm a, const ymm b) noexcept force_inline;
static inline ymm divpd2(const ymm a, const ymm b) noexcept { return _mm256_div_pd(a, b); }
...
template <int s> static inline ymm cnj_getwp2(const_complex_vector W, const int p) noexcept
{
    ...
    //return cnjpz2(cmplx2(W[sp0], W[sp1]));
}

static inline xmm getlo(const ymm a_b) noexcept force_inline;
static inline xmm getlo(const ymm a_b) noexcept { return _mm256_castpd256_pd128(a_b); }
static inline xmm gethi(const ymm a_b) noexcept force_inline;
static inline xmm gethi(const ymm a_b) noexcept { return _mm256_extractf128_pd(a_b, 1); }
