# OTFFT-6.5m
ここにあるのは [Stockham FFT アルゴリズムの解説](http://wwwa.pikara.ne.jp/okojisan/stockham/index.html) で紹介されている「OTFFT(OKおじさん Template FFT ライブラリ)」に、使いやすいように変更を加えたものです。現在のコードは、オリジナルの OTFFT-6.5 がベースになっています。※このバージョンに関する連絡はオリジナルの開発者の OK おじさんではなく、akinomyoga (Koichi Murase) にお願い致します。
